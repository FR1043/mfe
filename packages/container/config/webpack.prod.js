...
// the PRODUCTION_DOMAIN secret will be the URL of the Cloudfront distribution. it will be pulled through the workflow yml file during build
...
const prodConfig = {
    ...
    output: {
        ...
        // in this case, the remoteEntry.js file will prepend all the folder names
    },
    plugins: [
        new ModuleFederationPlugin({
            name: 'container',
            remotes: {
                marketing: `marketing@${domain}/marketing/latest/remoteEntry.js` // assuming the remoteEntry.js file is nested inside the domain/marketing/
            },
